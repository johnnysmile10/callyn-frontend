...
export const SUPPORTED_COUNTRIES: Country[] = [
  ...
  { code: "US", name: "United States", flag: "🇺🇸", dialCode: "+1", popular: true },
  { code: "CA", name: "Canada", flag: "🇨🇦", dialCode: "+1", popular: true },
  { code: "GB", name: "United Kingdom", flag: "🇬🇧", dialCode: "+44", popular: true },
  { code: "AU", name: "Australia", flag: "🇦🇺", dialCode: "+61", popular: true },
  { code: "DE", name: "Germany", flag: "🇩🇪", dialCode: "+49", popular: true },
  { code: "FR", name: "France", flag: "🇫🇷", dialCode: "+33", popular: true },
  { code: "JP", name: "Japan", flag: "🇯🇵", dialCode: "+81", popular: true },
  { code: "SG", name: "Singapore", flag: "🇸🇬", dialCode: "+65", popular: true },
...
export const getPopularCountries = (): Country[] => {
  return SUPPORTED_COUNTRIES.filter(country => country.popular);
};
