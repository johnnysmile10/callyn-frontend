...
import { Building, Target, Users, ArrowRight, ArrowLeft, Lightbulb } from "lucide-react";
    ...
    <div className="max-w-4xl mx-auto">
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          {/* Preview Box */}
          {formData.businessName && formData.targetAudience && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <h4 className="font-medium text-blue-900 mb-2">✨ Preview: How Callyn will introduce your business</h4>
